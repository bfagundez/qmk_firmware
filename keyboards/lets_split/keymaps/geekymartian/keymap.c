...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, KC_TILD,  KC_LPRN, KC_RPRN, KC_UNDS,  KC_LEFT,KC_DOWN,  KC_UP,   KC_RIGHT, _______, _______,\
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,\
  RGB_HUI, RGB_VAI, RGB_SAI, _______, RGB_MOD, _______, _______, _______, _______, _______, _______, _______, \
  RGB_HUD, RGB_VAD, RGB_SAD, _______, RGB_RMOD,RGB_TOG, _______, _______, _______, _______,  _______, _______ \
)
